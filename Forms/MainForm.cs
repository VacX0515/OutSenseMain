...
namespace VacX_OutSense
{
    public partial class MainForm : Form
    {
        ...
        private void UpdateDryPumpButtonStates()
        {
            ...
            btnDryPumpStart.Enabled = _dryPump.IsConnected && !_dryPump.Status.IsRunning && !_dryPump.Status.IsStopping;
        ...
        private void UpdateTurboPumpUI()
        {
            ...
            // 속도 게이지 업데이트
            progressTurboPumpSpeed.Value = _turboPump.GetSpeedPercentage();
